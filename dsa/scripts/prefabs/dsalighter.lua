...
local function fn(Sim)
	...
	inst.components.inventoryitem:ChangeImageName("lighter")
    -----------------------------------
	...
	inst.components.inspectable.nameoverride = "lighter"
    -----------------------------------
...
return Prefab( "common/inventory/dsalighter", fn, assets, prefabs) 
